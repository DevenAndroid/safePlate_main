...
class _CommunityScreenState extends State<CommunityScreen> {
  Rx<RxStatus> statusOfpost = RxStatus
      .empty()
      .obs;
  ...
  Rx<RxStatus> statusOfmylike = RxStatus
      .empty()
      .obs;
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      DateTime dateTime = DateTime.parse(
                          model.value.post![index].createdAt.toString());
                      String formattedDate = DateFormat('yyyy dd MMMM')
                          .format(dateTime);
                      return Padding(
