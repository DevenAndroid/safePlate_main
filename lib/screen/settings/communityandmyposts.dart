...
class _CommunityAndMyPostsState extends State<CommunityAndMyPosts> {
  ...
  Future<void> removeMember(String memberEmail, String cookie) async {
    final String url =
        'https://safegate.virtualdemo.tech/api/v1/removemember?membersemail=$memberEmail';
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print('Failed to remove member: ${response.statusCode}');
      }
    } catch (e) {
      print('Error: $e');
    }
